                ...
                <ul class="menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="{{ url('/logout') }}" id="logout"><i class="fa fa-btn fa-sign-out"></i>Logout</a></li>
                        </ul>
                    </li>
                    @endif
            ...
            <div class="modal-dialog modal-sm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="text-center text-muted"><a class="btn btn-link text-muted" href="{{ url('/password/reset') }}">Forgot Your Password?</a></p>
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="index.html" data-animate-hover="bounce">
                    ...
                    <!-- <img src="img/logo.png" alt="siri logo" class="hidden-xs">
                    <img src="img/logo-small.png" alt="siri logo" class="visible-xs"><span class="sr-only">siri - go to homepage</span> -->
                </a>
                ...
                <form class="navbar-form" role="search">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button type="button" class="btn btn-primary" id="searchBtn" data-link = "{{url('show')}}"><i class="fa fa-search"></i></button>
                        </span>
                    </div>
                </form>
            </div>
